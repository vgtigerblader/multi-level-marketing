...
?>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"><i class="fa fa-edit"></i> Add Feature
                        <small></small>
                    </h3>
                    <!-- END PAGE TITLE-->
...
$res = mysql_query("INSERT INTO features SET name='".$name."', stext='".$stext."', icon='".$icon."'");
echo mysql_error();
if($res){
...
if(isset($_GET['did'])) {
$did = $_GET["did"];
$exist = mysql_fetch_array(mysql_query("SELECT COUNT(*) FROM features WHERE id='".$did."'"));
if($exist[0]>=1){
    
$res = mysql_query("DELETE FROM features WHERE id='".$did."'");
...
$ddaa = mysql_query("SELECT id, name, stext FROM features ORDER BY id");
echo mysql_error();
